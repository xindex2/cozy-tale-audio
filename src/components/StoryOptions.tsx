  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6 animate-fade-in">
      <div className="text-center space-y-2">
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
          Bedtime Stories
        </h1>
        <p className="text-blue-600/90">Customize your perfect bedtime story</p>
      </div>
